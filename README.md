...
- [PKI Module](#pki-module)
  ...
  - [Working with PKI Module UI](#working-with-pki-module-ui)
    - [Retrive lost key id](#retrive-lost-key-id)
...
``` 
> **Note**: *key_id* paremeter is important to make this key work on Hashicorp Vault PKI Module UI. See section: [Working with PKI Module UI](#working-with-pki-module-ui)
...
```
> **Note**: reference in *imported_keys* array paremeter is important to make this key work on Hashicorp Vault PKI Module UI. See section: [Working with PKI Module UI](#working-with-pki-module-ui)
